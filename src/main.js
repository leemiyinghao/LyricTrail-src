...
class PVScene {
  constructor(url) {
    ...
    // 初始化 TextAlive App
    this.player = new Player({ app: true, mediaElement: document.getElementById("media") });
  ...
  initPlayer() {
    this.player.addListener({
      ...
      onPlay: () => {
        ...
        this.otherMeshes = [];
        console.log("playing");
        document.getElementById("player-outer").classList.add("playing");
      ...
      onPause: () => {
        ...
        console.log("paused");
        if (!this.isPanning) {
          document.getElementById("player-outer").classList.remove("playing");
...
document.getElementById("song1").onclick = ()=>{
  document.getElementById("menu").style.display = "none";
  document.getElementById("player-outer").style.display = "block";
  const pvScene = new PVScene("https://www.youtube.com/watch?v=ygY2qObZv24");
}
document.getElementById("song2").onclick = ()=>{
  document.getElementById("menu").style.display = "none";
  document.getElementById("player-outer").style.display = "block";
  const pvScene = new PVScene("http://www.youtube.com/watch?v=a-Nf3QUFkOU");
}
document.getElementById("song3").onclick = ()=>{
  document.getElementById("menu").style.display = "none";
  document.getElementById("player-outer").style.display = "block";
  const pvScene = new PVScene("https://www.youtube.com/watch?v=XSLhsjepelI");
}